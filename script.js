...
mm.addEventListener("click", maldonadoImage);
rc.addEventListener("click", chorinosImage);
...
function maldonadoImage(){
	mm.src = "images/the_machete.png";
}
function chorinosImage(){
	rc.src = "images/chorinos_thank_you_jesus.jpg";
}
